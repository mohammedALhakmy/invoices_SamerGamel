                        ...
                        <div class="col">
                            ...
                            <select name="Section" class="form-control select2" onclick="console.log($(this).val())"
                                ...
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id }}"> {{ app()->getLocale() === 'ar' ? $section->section_name_ar : $section->section_name_en }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('section.Details',$invoice->id) }}">{{ app()->getLocale() === 'ar' ? $invoice->section->section_name_ar : $invoice->section->section_name_en }}</a>
                                        </td>
