                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                ...
                                <option value="2">{{__('messages.not buy')}}</option>
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ url('InvoicesDetails') }}/{{ $invoice->id }}">{{app()->getLocale() === 'ar' ? $invoice->section->section_name_ar : $invoice->section->section_name_en }}</a>
                                        </td>
                                        ...
                                        <td>
                                            @if ($invoice->status == 1)
                                                <span class="text-success">{{__('messages.good buy')}}</span>
                                            @elseif($invoice->Value_Status == 2)
                                                <span class="text-danger">{{__('messages.not buy')}}</span>
                                            @else
                                                <span class="text-warning">{{ __('messages.par buy') }}</span>
                                            @endif

                                        </td>

                                        <td>{{ app()->getLocale() === 'ar' ? $invoice->note_ar : $invoice->note_en }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
