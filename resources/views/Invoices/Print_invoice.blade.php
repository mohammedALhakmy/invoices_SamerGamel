                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">{{ __('messages.Invoices Buy') }}</h1>
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>القسم</span>
                                    <span> {{ app()->getLocale()  === 'ar'  ? $invoices->section->section_name_ar : $invoices->section->section_name_en}} </span>
                                </p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="tx-center">{{ number_format($invoices->Amount_collection, 2) }}AB2</td>
                                    <td class="tx-right">{{ number_format($invoices->Amount_Commission, 2) }}AB1</td>
                                    @php
                                ...
                                <tr>
                                    ...
                                    <td class="tx-right">الاجمالي  مبلغ التحصيل</td>
                                ...
                                <tr>
                                    <td class="tx-right tx-uppercase tx-bold tx-inverse">الاجمالي شامل الضريبة  + مبلغ العموله</td>
