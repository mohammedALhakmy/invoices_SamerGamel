...
//        dd($request);
        ...
        return redirect()->route('users.indexs')->with('success','User created successfully');
    }



    /*** Display the specified
     * resource.** @param  int  $id * @return \Illuminate\Http\Response
     */
    ...
    public function update(Request $request, $id){
        ...
        $user->assignRole($request->input('roles'));
        return redirect()->route('users.indexs')->with('success','User updated successfully');
    }
