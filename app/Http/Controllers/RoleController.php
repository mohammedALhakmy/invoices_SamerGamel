...
class RoleController extends Controller{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('roles.users')->with('success','Role created successfully');
    }
    ...
    public function edit($id){
        ...
        $rolePermissions = DB::table("role_has_permissions")->where("role_has_permissions.role_id",
            $id)->pluck('role_has_permissions.permission_id',
...
//        dd($request->all());
        ...
        $role->save();
        $role->syncPermissions($request->input('permission'));
        return redirect()->route('roles.users')->with('success','Role updated successfully');
    ...
    public function destroy($id){
        ...
        return redirect()->route('roles.users')->with('success','Role deleted successfully');
    }
}
